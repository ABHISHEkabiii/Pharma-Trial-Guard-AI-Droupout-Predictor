...
<!-- ✅ ANIMATED 3D ROBOT BANNER — self-hosted SVG, always works on GitHub -->
<img src="./assets/banner.svg" width="100%" alt="PharmaTrialGuard Banner"/>
...
<!-- ✅ ANIMATED FOOTER WAVE — self-hosted SVG -->
